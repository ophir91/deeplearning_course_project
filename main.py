...
my_model = model(package_name=package_name, model_name=model_name, args=model_arg, description='6_experts', model_path = 'saved_models/Feb11_18-41_ClassifaierAndDenoise_6_experts_234_Adam_MSELoss.pth.tar')
...
my_model.train(num_epochs=500, trainloader=trainloader, epochs_per_save=5, valloader=validloader)
